...
void ImGui::RenderText(ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash)
{
    ...
    if (text_len > 0)
    {
		...
		ImVec4 col = ImVec4(0.01f, 0.01f, 0.01f, 1.0f);
		outlinepos.x = pos.x + 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end);
		outlinepos.x = pos.x - 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end);
		outlinepos.y = pos.y + 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end);
		outlinepos.y = pos.y - 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end);
...
void ImGui::RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect)
{
    ...
    else
    {
		...
		ImVec4 col = ImVec4(0.01f, 0.01f, 0.01f, 1.0f);
		outlinepos.x = pos.x + 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end, 0.0f, NULL);
		outlinepos.x = pos.x - 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end, 0.0f, NULL);
		outlinepos.y = pos.y + 1.0f;
		window->DrawList->AddText(g.Font, g.FontSize, outlinepos, GetColorU32(col), text, text_display_end, 0.0f, NULL);
...

{
	...
	if (*v)
	{
		...
		window->DrawList->AddPolyline(pts, 3, GetColorU32(ImGuiCol_CheckMark), false, 2.0f);
	}
