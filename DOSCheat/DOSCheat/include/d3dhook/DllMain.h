...
void MainThreadD3D( void* pHandle )
{
	// Hook d3d
	if (HookD3D())
	{
...
BOOL WINAPI DllMain( HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved )
{
	switch (fdwReason)
	{
		case DLL_PROCESS_ATTACH:
			...
			CreateThread( nullptr, 0, (LPTHREAD_START_ROUTINE)MainThreadD3D, hinstDLL, 0, nullptr );
			break;
...
bool HookD3D()
{
	...
	sd.BufferDesc.Height = 2560;
	sd.BufferDesc.Width = 1440-19;
	sd.BufferDesc.RefreshRate = { 144, 1 };
	sd.OutputWindow = fProcess.__HWND;
	sd.Windowed = TRUE;
